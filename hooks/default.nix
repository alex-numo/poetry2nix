{ python, buildPackages, makeSetupHook, wheel, pip, pkgs }:
let
    ...
    nonOverlayedPython.pkgs.callPackage ({ }:
      makeSetupHook {
        ...
        substitutions = {
          ...
          pythonPath =
            nonOverlayedPython.pkgs.makePythonPath [ nonOverlayedPython ];
  ...
  poetry2nixFixupHook = callPackage ({ }:
    makeSetupHook {
      ...
      substitutions = {
        ...
        filenames =
          builtins.concatStringsSep " " [ "pyproject.toml" "README.md" ];
      };
    } ./fixup-hook.sh) { };
